...
df_all=pd.concat([df01,df02,df03,df04,df05,df06]).reset_index(drop=True)
#print(df_all)
#print(df_all.ID)
...
df_out.to_csv('gasp_target_fitsheader_info_exclude_baddata_join.txt',sep='|',index=False)
