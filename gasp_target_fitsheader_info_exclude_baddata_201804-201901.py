...
'''
print('... will generate table from fitsheader from 201804 to 201901')
...
file_log='gasp_target_fitsheader_info_exclude_baddata_201804-201901.log'
...
'''
cmd_search_folder1='find ./ |grep calib | grep slt20180[4-9]| cut -d / -f3 | sort |uniq'
f_log.write(cmd_search_folder1+'\n')
list_folder1=os.popen(cmd_search_folder1,"r").read().splitlines()
cmd_search_folder2='find ./|grep calib | grep slt20181[0-2]| cut -d / -f3 | sort |uniq'
f_log.write(cmd_search_folder2+'\n')
list_folder2=os.popen(cmd_search_folder2,"r").read().splitlines()
cmd_search_folder3='find ./|grep calib | grep slt201901| cut -d / -f3 | sort |uniq'
...
'''
cmd_search_folder='find ./data_201804-201901_wcsfixed/ |grep calib | cut -d / -f3 | sort |uniq'
print(cmd_search_folder)
f_log.write(cmd_search_folder+'\n')
list_folders=os.popen(cmd_search_folder,"r").read().splitlines()
...
#cmd_search_file_sci="find ./data_201804-201901_wcsfixed |grep 'fits\|fts'|grep calib_sci |sort "
cmd_search_file_sci="find ./data_201804-201901_wcsfixed |grep new|grep calib_sci |sort "
print(cmd_search_file_sci)
f_log.write(cmd_search_file_sci+'\n')
list_file_sci=os.popen(cmd_search_file_sci,"r").read().splitlines()
