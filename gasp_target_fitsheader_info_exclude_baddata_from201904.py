...
file_log='gasp_target_fitsheader_info_exclude_baddata_from201904.log'
...
cmd_search_folder1='find ./|grep calib | grep slt20190[4-9]| cut -d / -f3 | sort |uniq'
f_log.write(cmd_search_folder1+'\n')
list_folder1=os.popen(cmd_search_folder1,"r").read().splitlines()
cmd_search_folder2='find ./|grep calib | grep slt20191[0-2]| cut -d / -f3 | sort |uniq'
...
cmd_search_file_sci1="find ./20190[4-9] |grep 'fits\|fts'|grep calib_sci |sort "
print(cmd_search_file_sci1)
f_log.write(cmd_search_file_sci1+'\n')
list_file_sci1=os.popen(cmd_search_file_sci1,"r").read().splitlines()
cmd_search_file_sci2="find ./20191[0-2] |grep 'fits\|fts'|grep calib_sci |sort "
