...
dir_obj='Vmag_InstMag/annu_w1_201909/'+obj_name+'/'
...
idx_fitsheader=df_info[(df_info['Object']==obj_name) & (df_info['FilterName']==filter_name)].index
...
file_Vmag_out_keep=dir_obj+'g'+iau_name_short+'r_LuS_'+date_format+'.dat'
