...
file_log='gasp_target_fitsheader_info_exclude_baddata_201811.log'
...
cmd_search_folder1='find ./|grep calib_sci | grep slt201811| cut -d / -f3 | sort |uniq'
...
cmd_search_file_sci1="find ./201811 |grep 'fits\|fts\|new' |grep calib_sci |sort "
