...
#        array_each_dark_time[j][:][:]=np.array(data_arr[:][:])
    ...
    dark_each_time_keep=reject_outliers_img_file(array_each_dark_time,par1)
#    dark_each_time_keep2=reject_outliers_img_file(dark_each_time_keep,3)
#    print(dark_keep)
    ...
    mean_dark_each_time_keep=reject_outliers_px(mean_dark_each_time,par3)
...
#        array_each_flat_filter_keep=reject_outliers_img_file(array_each_flat_filter,3)
