...
generate master bias, master dark, master flat for slt201908.
$ condaa
...
print('...generate master files on '+date+'...')
...
bias_keep2=reject_outliers_2x2img(bias_keep,3)
#print(bias_keep)

print('...generate master bias...')
master_bias=np.nanmean(bias_keep2, axis=0)
#print(master_bias)
...
#dark_keep=reject_outliers_2x2img(array_each_dark,3)
#dark_keep2=reject_outliers_2x2img(dark_keep2,3)
#print(bias_keep)
...
#        array_each_dark_time[j][:][:]=np.array(data_arr[:][:])
    ...
    dark_each_time_keep2=reject_outliers_2x2img(dark_each_time_keep,3)
#    print(dark_keep)
