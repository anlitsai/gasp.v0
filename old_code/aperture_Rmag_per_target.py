...
#    print('aper_annu_sum0',aper_annu_sum0)
    aper_annu_sum1=phot_annu_table['aperture_sum_1']
#    print('aper_annu_sum1',aper_annu_sum1)
...
#sys.exit(0)
    ...
    for j in range(n_refstar):
        ...
        print(final_sum[j],mag_instrument[j],rmag[j])
...
''' 
file_reg_fk5=dir_refstar+'RefStar_'+obj_name+'_mod_fk5.reg'
