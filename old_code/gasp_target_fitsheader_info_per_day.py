...
file_info='gasp_target_fitsheader_info_'+folder+'.txt'
if os.path.exists(file_info):
    os.remove(file_info)
f_info=open(file_info,'w')

file_log='gasp_target_fitsheader_info_'+folder+'.log'
...
cmd_search_file_sci="find ./|grep "+folder+"|grep 'fts\|fits'|grep GASP |sort -t'@'"
