...
file_info='gasp_target_fitsheader_info_exclude_nowcs.txt'
if os.path.exists(file_info):
    os.remove(file_info)
f_info=open(file_info,'w')

file_log='gasp_target_fitsheader_info_exclude_nowcs.log'
...
#        print(info_sci)
        ...
        nowcs=nowcs+1
        f_log.write(filename_sci+' has no wcs ...\n')


f_log.write('\n')    
f_log.write('... there are '+str(nowcs)+' files have no wcs coordinate ...\n')    
